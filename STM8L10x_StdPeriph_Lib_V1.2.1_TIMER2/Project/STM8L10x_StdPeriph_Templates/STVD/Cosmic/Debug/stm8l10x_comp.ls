...
1035                     ; 307   FlagStatus status = RESET;
1037                     ; 310   assert_param(IS_COMP_OUTPUT(COMP_Output));
1039                     ; 312   if ((COMP->CSR & (uint8_t)COMP_Output) != 0)
1041  0001 c45301        	and	a,21249
1042  0004 2702          	jreq	L554
1043                     ; 314     status = SET;
1045  0006 a601          	ld	a,#1
1047  0008               L554:
1048                     ; 318     status = RESET;
1050                     ; 320   return status;
1054  0008 5b01          	addw	sp,#1
1055  000a 81            	ret	
...
1129                     ; 333   FlagStatus status = RESET;
1131                     ; 336   assert_param(IS_COMP_FLAG(COMP_Flag));
1133                     ; 338   if ((COMP->CSR & (uint8_t)COMP_Flag) != 0)
1135  0001 c45301        	and	a,21249
1136  0004 2702          	jreq	L315
1137                     ; 340     status = SET;
1139  0006 a601          	ld	a,#1
1141  0008               L315:
1142                     ; 344     status = RESET;
1144                     ; 346   return status;
1148  0008 5b01          	addw	sp,#1
1149  000a 81            	ret	
...
1253                     ; 376   ITStatus status = RESET;
1255                     ; 379   assert_param(IS_COMP_ITPENDINGBIT(COMP_ITPendingBit));
1257                     ; 381   if (COMP->CSR & (uint8_t)COMP_ITPendingBit)
1259  0001 c45301        	and	a,21249
1260  0004 2702          	jreq	L755
1261                     ; 383     status = SET;
1263  0006 a601          	ld	a,#1
1265  0008               L755:
1266                     ; 387     status = RESET;
1268                     ; 389   return status;
1272  0008 5b01          	addw	sp,#1
1273  000a 81            	ret	
