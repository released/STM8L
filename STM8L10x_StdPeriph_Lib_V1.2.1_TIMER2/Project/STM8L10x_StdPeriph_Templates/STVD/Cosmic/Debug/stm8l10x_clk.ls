 ...
 562                     ; 187   presc = HSIDivFactor[tmp];
 564  0007 5f            	clrw	x
 565  0008 97            	ld	xl,a
 566  0009 d60000        	ld	a,(_HSIDivFactor,x)
 567  000c 6b09          	ld	(OFST+0,sp),a
 568                     ; 188   clockfrequency = HSI_VALUE / presc;
 570  000e b703          	ld	c_lreg+3,a
 571  0010 3f02          	clr	c_lreg+2
 572  0012 3f01          	clr	c_lreg+1
 573  0014 3f00          	clr	c_lreg
 574  0016 96            	ldw	x,sp
 575  0017 5c            	incw	x
 576  0018 cd0000        	call	c_rtol
 578  001b ae2400        	ldw	x,#9216
 579  001e bf02          	ldw	c_lreg+2,x
 580  0020 ae00f4        	ldw	x,#244
 581  0023 bf00          	ldw	c_lreg,x
 582  0025 96            	ldw	x,sp
 583  0026 5c            	incw	x
 584  0027 cd0000        	call	c_ludv
 586  002a 96            	ldw	x,sp
 587  002b 1c0005        	addw	x,#OFST-4
 588  002e cd0000        	call	c_rtol
 590                     ; 190   return((uint32_t)clockfrequency);
 592  0031 96            	ldw	x,sp
 593  0032 1c0005        	addw	x,#OFST-4
 594  0035 cd0000        	call	c_ltor
 598  0038 5b09          	addw	sp,#9
 599  003a 81            	ret	
 624                     	xdef	_HSIDivFactor
 625                     	xdef	_CLK_GetClockFreq
 626                     	xdef	_CLK_CCOConfig
 627                     	xdef	_CLK_MasterPrescalerConfig
 628                     	xdef	_CLK_PeripheralClockConfig
 629                     	xdef	_CLK_CCOCmd
 630                     	xdef	_CLK_DeInit
 631                     	xref.b	c_lreg
 632                     	xref.b	c_x
 651                     	xref	c_ltor
 652                     	xref	c_ludv
