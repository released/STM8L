 ...
 470                     ; 152   A = (uint16_t)(lsifreqkhz >> 2U); /* Division by 4, keep integer part only */
 472  0013 54            	srlw	x
 473  0014 54            	srlw	x
 ...
 480  001b 1e03          	ldw	x,(OFST-3,sp)
 481  001d 72f001        	subw	x,(OFST-5,sp)
 482  0020 1605          	ldw	y,(OFST-1,sp)
 483  0022 9058          	sllw	y
 484  0024 905c          	incw	y
 485  0026 cd0000        	call	c_imul
 487  0029 1605          	ldw	y,(OFST-1,sp)
 488  002b 9058          	sllw	y
 489  002d bf00          	ldw	c_x,x
 490  002f 9058          	sllw	y
 491  0031 90b300        	cpw	y,c_x
 492  0034 7b06          	ld	a,(OFST+0,sp)
 493  0036 2504          	jrult	L561
 494                     ; 156     AWU->APR = (uint8_t)(A - 2U);
 496  0038 a002          	sub	a,#2
 498  003a 2001          	jra	L761
 499  003c               L561:
 500                     ; 160     AWU->APR = (uint8_t)(A - 1U);
 502  003c 4a            	dec	a
 503  003d               L761:
 504  003d c750f1        	ld	20721,a
 505                     ; 163 }
 508  0040 5b06          	addw	sp,#6
 509  0042 81            	ret	
 ...
 599  0000 720a50f002    	btjt	20720,#5,L22
 600  0005 4f            	clr	a
 602  0006 81            	ret	
 603  0007               L22:
 604  0007 a601          	ld	a,#1
 607  0009 81            	ret	
 642                     	xdef	_TBR_Array
 643                     	xdef	_APR_Array
